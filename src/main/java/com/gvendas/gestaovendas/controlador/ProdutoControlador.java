...
public class ProdutoControlador {
	...
	@ApiOperation(value = "Listar", nickname = "listarProdutos")
	@GetMapping
	...
	public ResponseEntity<ProdutoResponseDTO> buscarPorCodigo(@PathVariable Long codigo,
		...
		Optional<Produto> produto = produtoServico.buscarPorCodigo(codigo, codigoCategoria); // foi no banco de dados
																								// ver se existe
		return produto.isPresent() ? ResponseEntity.ok(ProdutoResponseDTO.converterParaProdutoDTO(produto.get())) // e
																													// converte
